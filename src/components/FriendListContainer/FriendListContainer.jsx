...
function FriendListContainer() {
  ...
  const handleFilterFriend = (event) => {
    setFilterFriend(event.target.value.toLowerCase())
  }

  return (
    <div className='flex flex-col w-[97%] p-10 gap-3 h-[99%] mt-20  bg-white lg:rounded-ss-3xl lg:rounded-ee-3xl lg:rounded-tr-[100px] rounded-3xl overflow-auto  lg:rounded-bl-[100px] shadow-darkGreen shadow-xl  justify-start text-green'>
      <div className='h-[50PX] flex items-center justify-center bg-lightestGreen p-3'>
        ...
        <input
          ...
          className='w-full bg-transparent placeholder:text-green h-full outline-none p-3'
